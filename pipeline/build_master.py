...
# Tutte le sorgenti e le uscite di questo script vivono in dati/. Lo script
# sta in pipeline/, quindi si sposta li' una volta all'avvio: cosi' i nomi di
# file qui sotto restano quelli semplici, e funziona lanciato da qualunque
# cartella - compresa la GitHub Action, che parte dalla radice della repo.
os.chdir(pathlib.Path(__file__).resolve().parent.parent / 'dati')
